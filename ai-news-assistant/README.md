...
项目文档统一存放在 [`doc/`](doc/) 目录：

| 文档 | 说明 |
|---|---|
| [需求描述](doc/AI信息搜索助手-需求描述.md) | 服务对象、核心任务、功能边界、非功能需求与验收口径 |
| [技术方案](doc/AI信息搜索助手-技术方案.md) | 基础/治理/收尾三大模块的代码级实现说明与关键设计取舍 |
| [SPEC](doc/AI信息搜索助手-SPEC.md) | 功能规格说明书 |
| [PLAN](doc/AI信息搜索助手-PLAN.md) | 总体开发计划 |
